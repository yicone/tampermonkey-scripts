...
(function () {
    ...
    let FIRST_RUN_KEY = "firstRun";
        setTimeout(function(){
        if (getGV('siteIconPack') !== SITE_ICON_PACK) {
            wordConfig.forEach(({ site: siteId }) => GM_deleteValue(SITE_ICON_KEY_PREFIX + siteId));
            setGV('siteIconPack', SITE_ICON_PACK);
        }
